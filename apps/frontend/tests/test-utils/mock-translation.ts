...
export const mockTranslations: Translation = {
  ...
  terminalCommands: {
    ...
    ls: { description: "List directory contents", usage: "ls [directory]" },
    cd: { description: "Change directory", usage: "cd [directory]" },
    cat: { description: "Display file contents", usage: "cat <file>" },
    mkdir: { description: "Create a directory", usage: "mkdir <directory>" },
    touch: { description: "Create an empty file", usage: "touch <file>" },
    rm: { description: "Remove files or directories", usage: "rm <file|directory>" },
    mv: { description: "Move or rename files", usage: "mv <source> <destination>" },
    vim: { description: "Text editor (vi-compatible)", usage: "vim <file>" },
    vi: { description: "Text editor", usage: "vi <file>" },
  },
  taskbar: {
    start: {
      title: "Start Menu",
